...
const translations = {
  en: {
    ...
    // Landing
    "landing.hero": "A field guide for turning taste into shipped interfaces.",
    "landing.subtitle": "Navigate the UI components, design systems, motion libraries, and AI workflow tools worth reaching for when product quality matters.",
    "landing.cta": "Enter the atlas",
    "landing.keyboard": "Keyboard driven · Press ? for shortcuts",
    "landing.designEngineering": "Editorial atlas for design engineering",
    "landing.navMeta": "Curated Resource Map",
    "landing.nodeDesign": "Design systems",
    "landing.nodeMotion": "Motion",
    "landing.nodeWorkflow": "AI workflow",
    "landing.mapLabel": "Taste / Engineering / AI",
    "landing.mapCardEyebrow": "Indexed terrain",
    "landing.mapCardTitle": "From reference to execution",
    "landing.mapCardDesc": "A living map of tools, patterns, and visual systems for product builders.",
  ...
  zh: {
    ...
    // Landing
    "landing.hero": "把审美判断转化为可交付界面的实战地图。",
    "landing.subtitle": "导航真正值得采用的 UI 组件、设计系统、动效库和 AI 工作流工具，用在需要产品质感的地方。",
    "landing.cta": "进入地图",
    "landing.keyboard": "键盘驱动 · 按 ? 查看快捷键",
    "landing.designEngineering": "设计工程的编辑型地图",
    "landing.navMeta": "精选资源地图",
    "landing.nodeDesign": "设计系统",
    "landing.nodeMotion": "动效",
    "landing.nodeWorkflow": "AI 工作流",
    "landing.mapLabel": "审美 / 工程 / AI",
    "landing.mapCardEyebrow": "索引地形",
    "landing.mapCardTitle": "从参考到落地",
    "landing.mapCardDesc": "为产品构建者整理工具、模式与视觉系统的动态地图。",
